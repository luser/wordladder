	...
	var Gritter = {
		...
		*/
		add: function(params){
			...
			if (this.add_at_top) $('#gritter-notice-wrapper').prepend(tmp);
			else $('#gritter-notice-wrapper').append(tmp);
			
			var item = $('#gritter-item-' + this._item_count);
			
			if (typeof this.fade_in_function == 'function') {
				this.fade_in_function(item, this.fade_in_speed, function(){
